...
var _FormEdit = require('../../components/FormEdit');
...
var ProfileEdit = function (_Component) {
  (0, _inherits3.default)(ProfileEdit, _Component);
  ...
  function ProfileEdit() {
    ...
    (0, _classCallCheck3.default)(this, ProfileEdit);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this2 = (0, _possibleConstructorReturn3.default)(this, (_ref = ProfileEdit.__proto__ || (0, _getPrototypeOf2.default)(ProfileEdit)).call.apply(_ref, [this].concat(args))), _this2), _this2.state = {
      user: {},
      userData: {},
      modalEdited: false,
      editOn: 'Profile',
    ...
    })), _this2.fetchGetUser = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3() {
      return _regenerator2.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return (0, _firebase.getUser)(function () {
                var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(user) {
                  var userData;
  ...
  (0, _createClass3.default)(ProfileEdit, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(_layouts2.default, { url: this.props.url }, _react2.default.createElement('div', { id: 'Profile' }, _react2.default.createElement(_reactstrap.Container, null, _react2.default.createElement(_reactstrap.Row, null, _react2.default.createElement(_reactstrap.Col, { xs: '12', sm: '6', md: '4', lg: '3' }, _react2.default.createElement(_reactstrap.Card, { className: 'card-user' }, _react2.default.createElement(_reactstrap.CardImg, { className: 'image', top: true, width: '100%',
        src: !_lodash2.default.isEmpty(imageProfile) ? imageProfile : 'https://cdn1.iconfinder.com/data/icons/IconsLandVistaPeopleIconsDemo/256/Person_Undefined_Female_Dark.png', alt: 'Card image cap' }), _react2.default.createElement('label', { style: { textAlign: 'center' } }, _react2.default.createElement('input', { accept: 'jpg,jpeg,JPG,JPEG', multiple: true, type: 'file', style: { display: 'none' },
        onChange: this.handleChangeProfileImage }), _react2.default.createElement('span', { className: 'btn btn-primary', style: { position: 'relative', cursor: 'pointer', width: '100%' } }, 'Change Image'))), _react2.default.createElement('br', null), _react2.default.createElement(_reactstrap.ListGroup, null, _react2.default.createElement(_reactstrap.ListGroupItem, { id: editOn === 'Profile' ? 'active' : '', onClick: function onClick() {
        ...
        }, tag: 'button', action: true }, 'Teacher'))), _react2.default.createElement(_reactstrap.Col, { xs: '12', sm: '12', md: '8', lg: '9' }, _react2.default.createElement(_reactstrap.Card, { className: 'head' }, _react2.default.createElement('h1', null, editOn)), _react2.default.createElement('br', null), _react2.default.createElement(_reactstrap.Card, { className: 'detail' }, !_lodash2.default.isEmpty(userData) && _react2.default.createElement(_FormEdit2.default, { at: editOn, userData: userData })))))));
    }
  }]);
...
exports.default = (0, _nextReduxWrapper2.default)(_store.initStore, null, mapDispatchToProps)(ProfileEdit);